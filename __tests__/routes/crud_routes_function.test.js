...
let controller = require("../../db-controller")
jest.mock("../../db-controller") // Allows an individual test access to a mock controller
jest.mock('./__mocks__/id') // A mock /v1/id/ endpoint that returns a promise
